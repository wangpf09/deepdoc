...
from app.picture import vision_llm_chunk as picture_vision_llm_chunk
from nlp import rag_tokenizer
from prompts import vision_llm_describe_prompt
from settings import PARALLEL_DEVICES
    ...
    def __init__(self, **kwargs):
        ...
        try:
            ...
            model_dir = snapshot_download(
                ...
                local_dir=os.path.join(get_project_base_directory(), "models/deepdoc"),
