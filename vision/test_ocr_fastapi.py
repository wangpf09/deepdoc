...
def test_ocr_api(file_path, api_url="http://localhost:8000/ocr"):
    """
    测试OCR API功能
...
if __name__ == "__main__":
    ...
    parser.add_argument('--api_url', help="OCR API的URL地址", default="http://localhost:8000/ocr")
    
    args = parser.parse_args()
    test_ocr_api(args.file, args.api_url)
    
    print("\n使用说明:")
    print("1. 首先启动OCR API服务: python3 vision/ocr_fastapi.py")
    print("2. 然后运行此测试脚本: python3 vision/test_ocr_fastapi.py --file=<文件路径>")
    print("3. 例如: python3 vision/test_ocr_fastapi.py --file=./temp/PDCC第二个里程碑技术出版物立项计划书.pdf")